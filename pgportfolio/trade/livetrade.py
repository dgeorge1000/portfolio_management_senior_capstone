...
class LiveTrade(trader.Trader):
    def __init__(self, config, net_dir=None, agent=None, agent_type="nn"):
        trader.Trader.__init__(self, config["input"]["global_period"], config, 0, net_dir,
    ...
    def trade_by_strategy(self, omega):
        ...
        pv_after_commission = calculate_pv_after_commission(omega, self._last_omega, self._commission_rate, self._margin_interest)
